...
cont_mean_std = torch.randn(2, 2)
model = TabTransformer(
    categories = (2, 4, 3, 2),      # tuple containing the number of unique values within each category
    num_continuous = 2,                # number of continuous values
...
x_cat = torch.tensor(df[cat_features].values, dtype=torch.int)
